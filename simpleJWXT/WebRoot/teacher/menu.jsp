			...
			<td style='padding-left:3px;padding-top:8px' valign="top">
				...
				<dl class='bitem'>
					...
					<dd style='display:block' class='sitem' id='items2_1'>
						<ul class='sitemu'>
							<!--  <li><a href='choose.action' target='main'>查询课程</a></li> -->
							<li><div align="left">
									<a href='lookCourse' target='main'>选修课信息</a>
								</div></li>
							<li><div align="left">
									<a href='lookCourse!registCourse' target='main'>成绩录入</a>
								</div></li>
						</ul>
					</dd>
				</dl>
				<dl class='bitem'>
					...
					<dd style='display:block' class='sitem' id='items2_1'>
						<ul class='sitemu'>
							...
							<li><div align="left">
									<a href="<%=request.getContextPath()%>/user/blank.jsp" target='main'>校园论坛</a>
								</div></li>
						</ul>
					</dd>
				</dl> <!-- Item 2 End -->
